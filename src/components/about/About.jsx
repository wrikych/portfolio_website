      ...
      <div className='container about__container'>
        ...
        <div className='about__content'>
          ...
          <p>
            ...
            is the core logic behind data science. Taking a bunch of noise and discerning a pattern from it - whether it be interpolating a function from a statistical distribution or feature engineering
            a data set to fit the constraints of a model - is something I've done my entire life. 
          </p>
          <p>
